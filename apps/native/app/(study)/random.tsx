...
export default function RandomStudyScreen() {
	...
	// FIX-0008: 랜덤 문제 가져오기 (기본값 가드)
	const { data: questions = [], isLoading } = trpc.question.getRandom.useQuery({ count: 10 });
